  ...
  <section class="showcase-section">
    <div class="showcase-grid">
      <div class="showcase-content">
        <div class="section-tag" style="margin-left:0;margin-right:auto">Pourquoi nous choisir</div>
