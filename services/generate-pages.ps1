  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .service-hero::before {
      ...
      background: linear-gradient(135deg, hsl(228 85% 8% / 0.88) 0%, hsl(218 100% 45% / 0.75) 60%, hsl(180 100% 45% / 0.65) 100%),
                  radial-gradient(ellipse at 70% 50%, hsl(180 100% 45% / 0.12) 0%, transparent 60%),
                  radial-gradient(ellipse at 20% 80%, hsl(218 100% 45% / 0.1) 0%, transparent 50%);
    }
    .service-hero::after {
    ...
    .showcase-image::after { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, hsl(218 100% 45% / 0.15) 0%, transparent 60%); }
    .showcase-title { font-family: 'Montserrat', sans-serif; font-size: clamp(1.6rem, 3vw, 2rem); font-weight: 800; color: hsl(var(--brand-anthracite)); margin-bottom: 16px; letter-spacing: -0.02em; }
    .showcase-title span { background: var(--futur-gradient-accent); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    .showcase-desc { font-size: 1rem; color: hsl(var(--brand-medium-gray)); line-height: 1.7; margin-bottom: 20px; }
    .showcase-list { list-style: none; margin-bottom: 28px; }
    .showcase-list li { display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid hsl(var(--brand-royal-blue) / 0.08); font-size: 0.95rem; color: hsl(var(--brand-anthracite)); font-weight: 500; }
    .showcase-check { width: 22px; height: 22px; border-radius: 50%; background: var(--futur-gradient-accent); display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 4px 10px hsl(218 100% 45% / 0.3); }
    .showcase-check svg { width: 11px; height: 11px; color: #fff; }
    .included-section { margin-bottom: 80px; }
    ...
    @media(max-width:768px){
      ...
      .showcase-tag { margin-left: auto !important; margin-right: auto !important; }
    }
  </style>
</head>
<body>
...
<section class="service-hero" style="background-image: url('../assets/$($service.bgImage)');">
  ...
  <section class="showcase-section">
    <div class="showcase-grid">
      <div class="showcase-content">
        <div class="section-tag showcase-tag" style="margin-left:0;margin-right:auto">Pourquoi nous choisir</div>
        <h2 class="showcase-title">Des <span>résultats</span> qui parlent d'eux-mêmes</h2>
        <p class="showcase-desc">$($service.desc)</p>
        <ul class="showcase-list">
          <li><span class="showcase-check"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg></span>$($service.included[0])</li>
          <li><span class="showcase-check"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg></span>$($service.included[1])</li>
          <li><span class="showcase-check"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg></span>$($service.included[2])</li>
        </ul>
      ...
      <div class="showcase-image">
        <img src="../assets/$($service.showcaseImage)" alt="$($service.title) - Futur Toiture" loading="lazy">
      </div>
    </div>
  </section>
