  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .gallery-card {
      ...
      border: 1px solid hsl(var(--brand-royal-blue) / 0.1);
      transition: all 0.35s ease; box-shadow: 0 4px 20px rgba(0,0,0,0.05);
      cursor: pointer;
    }
    ...
    .gallery-content h4 {
      ...
      color: hsl(var(--brand-anthracite)); margin-bottom: 6px;
    }
    .gallery-content p {
      font-size: 0.85rem; color: hsl(var(--brand-medium-gray)); line-height: 1.5;
    }
...
$featuresHtml    </div>
  ...
  <section class="gallery-section">
    <div class="section-tag">Nos réalisations</div>
    <h2 class="section-title">Découvrez <span>nos projets</span></h2>
    <p class="section-desc">Un aperçu de notre savoir-faire à travers nos chantiers récents dans le Gard et alentours.</p>
    <div class="gallery-grid">
      <div class="gallery-card">
        <div class="gallery-image"><img src="../assets/hero-renovation-Du0P25_j.jpg" alt="Rénovation complète de toiture" loading="lazy"></div>
        <div class="gallery-content"><h4>Rénovation complète</h4><p>Transformation totale de toiture avec charpente neuve et couverture tuiles.</p></div>
      </div>
      <div class="gallery-card">
        <div class="gallery-image"><img src="../assets/chantier-charpente-CxZLnn1L.webp" alt="Charpente traditionnelle" loading="lazy"></div>
        <div class="gallery-content"><h4>Charpente neuve</h4><p>Structure bois traditionnelle assemblée dans les règles de l'art.</p></div>
      </div>
      <div class="gallery-card">
        <div class="gallery-image"><img src="../assets/travaux-tuiles-pro-CGYiIDxj.webp" alt="Pose de tuiles professionnelle" loading="lazy"></div>
        <div class="gallery-content"><h4>Pose de tuiles</h4><p>Couverture haut de gamme en tuiles terre cuite ou ardoises naturelles.</p></div>
      </div>
      <div class="gallery-card">
        <div class="gallery-image"><img src="../assets/etancheite-toiture-BoHIUlIj.webp" alt="Étanchéité toiture garantie" loading="lazy"></div>
        <div class="gallery-content"><h4>Étanchéité garantie</h4><p>Protection durable contre les infiltrations et les intempéries.</p></div>
      </div>
      <div class="gallery-card">
        <div class="gallery-image"><img src="../assets/renovation-toiture-pro-DW_UCQUP.webp" alt="Installation Velux" loading="lazy"></div>
        <div class="gallery-content"><h4>Installation Velux</h4><p>Apportez lumière naturelle et confort à vos combles aménagés.</p></div>
      </div>
      <div class="gallery-card">
        <div class="gallery-image"><img src="../assets/chantier-propre-pro-DFRsqp1K.webp" alt="Chantier propre et soigné" loading="lazy"></div>
        <div class="gallery-content"><h4>Chantier soigné</h4><p>Respect de votre propriété avec nettoyage complet après chaque intervention.</p></div>
      </div>
    </div>
  </section>
